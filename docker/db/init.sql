...
CREATE TABLE `usuario_roles` (
                                 ...
                                 KEY `FKqfgf3b925b6a7a1b32d67a1c3b` (`usuario_id`),
                                 CONSTRAINT `FKqfgf3b925b6a7a1b32d67a1c3b` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `usuario_roles` WRITE, `usuarios` READ;
